    ...
    public static void influenceAdam() throws Exception {
        ...
        if (safetyAfterOpposite >= 0 && safetyAfterOpposite - safetyAfterSelf >= 0) {
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkable' enhanced (Eve's tenderness makes Adam reminding of his mother.) ");
            } else if (sa >= 1) {
        ...
        if (respectAfterOpposite >= 0 && respectAfterOpposite - respectAfterSelf >= 0) {
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' enhanced (Everyone likes to mention Adam as a good guy in the neighborhood, especially Eve.) ");
            } else if (re >= 1) {
            ...
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' weakened (Despite of his rude friend Eve, Adam is good, says everyone in town.) ");
            } else if (re >= 1) {
            ...
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' weakened (Adam feels severe humiliated by Eve's constant mock.) ");
            } else if (re >= 1) {
            ...
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' enhanced (Eve shows huge respect to the disrespectful Adam.) ");
            } else if (re >= 1) {
    ...
    public static void influenceEve() throws Exception {
        ...
        if (safetyAfterOpposite >= 0 && safetyAfterOpposite - safetyAfterSelf >= 0) {
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkable' enhanced (Adam's tenderness makes Eve reminding of her mother.) ");
            } else if (sa >= 1) {
        ...
        if (respectAfterOpposite >= 0 && respectAfterOpposite - respectAfterSelf >= 0) {
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' enhanced (Everyone likes to mention Eve as a good guy in the neighborhood, especially Adam.) ");
            } else if (re >= 1) {
            ...
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' weakened (Despite of her rude friend Adam, Eve is good, says everyone in town.) ");
            } else if (re >= 1) {
            ...
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' weakened (Eve feels severe humiliated by Adam's constant mock.) ");
            } else if (re >= 1) {
            ...
            if (re < 0.5) {
                ...
                System.out.println("Sense of esteem 'remarkable' enhanced (Adam shows huge respect to the disrespectful Eve.) ");
            } else if (re >= 1) {
