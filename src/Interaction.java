...
public class Interaction {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Physical needs: " + Human.physical);
        System.out.println("Sense of safety: " + Human.safety);
        System.out.println("Social satisfaction: " + Human.social);
        System.out.println("Sense of esteem: " + Human.respect);
        System.out.println("Self-fulfillment: " + Human.selfAchievement);
        System.out.println("Intrinsic Value: " + Human.overAchievement);
        System.out.println("Affection: " + Human.feeling);
        System.out.println("Bond between two people: " + Human.affection);
        System.out.println("=====================================");
        reset();
        influenceEve();
        System.out.println("");
    ...
    public static void influenceAdam() throws Exception {
        ...
        if (physicalAfterOpposite >= 0 && physicalAfterOpposite - physicalAfterSelf >= 0) {
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' enhanced (Eve brings obvious changes to Adam's physical needs, now Adam becomes more lustful and gluttonous.) ");
            } else if (p >= 1) {
            ...
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' weakened (Although Eve shows no her interest on body pressure, which does not stop Adam indulging himself sometimes.) ");
            } else if (p >= 1) {
            ...
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' weakened (Eve brought obvious changes to Adam's physical needs, now Adam starts to feel tedious about chasing fancy foods, beautiful women etc.) ");
            } else if (p >= 1) {
            ...
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' enhanced (Although Eve does obvious changes to Adam's physical needs, Adam still feel a little bit tedious about chasing fancy foods, beautiful women etc.) ");
            } else if (p >= 1) {
        ...
        if (safetyAfterOpposite >= 0 && safetyAfterOpposite - safetyAfterSelf >= 0) {
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' enhanced (Eve's tenderness makes Adam reminding of his mother.) ");
            } else if (sa >= 1) {
                System.out.println("Sense of safety 'tremendously' enhanced (Eve's the sun for Adam, bringing endless warmth.)");
            }
            ...
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' weakened (Eve always makes life more insecure, even tough guy like Adam cannot stop worrying them.)");
            } else if (sa >= 1) {
            ...
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' weakened (Adam feel the hostility of surrounding in daily life, especially when Eve breaks in.) ");
            } else if (sa >= 1) {
            ...
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' enhanced (Eve tries many times to tell Adam that nobody will hurt him. Adam still cannot make himself relieved.) ");
            } else if (sa >= 1) {
        ...
        if (socialAfterOpposite >= 0 && socialAfterOpposite - socialAfterSelf >= 0) {
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' enhanced (Eve does not hesitate to introduce Adam to all her friends that makes Adam happy indeed.) ");
            } else if (so >= 1) {
            ...
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' weakened (Playful Adam never can understand the aloofness of Eve, but he is influenced obviously. Now he accepts a quite weekend at home sometimes.) ");
            } else if (so >= 1) {
            ...
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' weakened (Eve constraint Adam so much, whatever, Adam now do not need social life like he used to be.) ");
            } else if (so >= 1) {
            ...
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' enhanced (Adam always feel himself in a noisy flea market when being with Eve, which makes him hard to bear.) ");
            } else if (so >= 1) {
        ...
        if (respectAfterOpposite >= 0 && respectAfterOpposite - respectAfterSelf >= 0) {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' enhanced (Adam is happy with Eve's good manner.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' enhanced (Everyone likes to mention Adam as a good guy in the neighborhood, especially Eve.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' enhanced (Adam is renowned all over the city and Eve is the first fan.) ");
            }
        } else if (respectAfterOpposite >= 0 && respectAfterOpposite - respectAfterSelf < 0) {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' weakened (Adam not quite like Eve's provocative winks, which is her signature move.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' weakened (Despite of his rude friend Eve, Adam is good, says everyone in town.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' weakened (Adam have more than a dozen of times to pour his angry on Eve's disrespectful behaviors, but he holds back.) ");
            }
        } else if (respectAfterOpposite < 0 && respectAfterOpposite - respectAfterSelf <= 0) {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' weakened (Adam feels embarrassed after receiving several negative comments by Eve.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' weakened (Adam feels severe humiliated by Eve's constant mock.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' weakened (Adam now has a desperate attitude towards life due to Eve's daily humiliation.) ");
            }
        } else {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' enhanced (Eve's lovely smile sometimes seems heart-touching to Adam, who is the bad boy in others' eyes.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' enhanced (Eve shows huge respect to the disrespectful Adam.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' enhanced (No one really gets to know Adam, the bad boy who is discard by the world. The only believer is Eve.) ");
            }
        }
        ...
        if (selfAchievementAfterOpposite >= 0 && selfAchievementAfterOpposite - selfAchievementAfterSelf >= 0) {
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' enhanced (Adam has a high-flying career with the help of Eve.) ");
            } else if (s1 >= 1) {
            ...
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' weakened (Adam always feels his hard work worth nothing after Eve's contempt.) ");
            } else if (s1 >= 1) {
            ...
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' weakened (Adam cannot stop the thoughts of having fun with Eve when at work.) ");
            } else if (s1 >= 1) {
            ...
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' enhanced (Eve helps a lot on Adams' work when Adam indulge himself too much.) ");
            } else if (s1 >= 1) {
        ...
        if (overAchievementAfterOpposite >= 0 && overAchievementAfterOpposite - overAchievementAfterSelf >= 0) {
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' enhanced (Eve tutors Adam on how to find his calling.) ");
            } else if (oa >= 1) {
            ...
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' weakened (Adam is more like to devote himself into something he really interested in while Eve has strong interested in gain social identity.) ");
            } else if (oa >= 1) {
            ...
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' weakened (Adam and Eve have consensus on the correctness of utilitarianism.) ");
            } else if (oa >= 1) {
            ...
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' enhanced (Eve leaves some unapparent marks on Adam about awaking, but all be washed away by Adam's ambition on self-fulfillment.) ");
            } else if (oa >= 1) {
        ...
        if (feelingAfterOpposite >= 0 && feelingAfterOpposite - feelingAfterSelf >= 0) {
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' enhanced (Eve likes Adam a lot. She starts to miss him when he is not around.) ");
            } else if (f >= 1) {
            ...
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' weakened (Adam is the beloved one in the relationship.) ");
            } else if (f >= 1) {
            ...
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' weakened (Everybody is not fond of our dirty little Adam, not mention of Eve.) ");
            } else if (f >= 1) {
            ...
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' enhanced (Don't get these two guys in one room, they will fight, I mean it.) ");
            } else if (f >= 1) {
        ...
        if (affectionAfterOpposite >= 0 && affectionAfterOpposite - affectionAfterSelf >= 0) {
            if (a < 0.5) {
                ...
                System.out.println("Bond between two people 'remarkably' enhanced (The connection between these two grows fast.) ");
            } else if (a >= 1) {
            ...
            if (a < 0.5) {
                ...
                System.out.println("Bond between two people 'remarkably' weakened (Adam feels that every time he tries to get closer to Eve, Eve pull back a little bit accordingly.) ");
            } else if (a >= 1) {
            ...
            if (a < 0.5) {
                ...
                System.out.println("Bond between two people 'remarkably' weakened (They just cannot accept each other as true friend.) ");
            } else if (a >= 1) {
            ...
            if (a < 0.5) {
                ...
                System.out.println("Bond between two people 'remarkably' enhanced (Eve tries so hard to get alone with Adam, but Adam really just do not feel a thing about Eve.) ");
            } else if (a >= 1) {
    ...
    public static void influenceEve() throws Exception {
        ...
        if (physicalAfterOpposite >= 0 && physicalAfterOpposite - physicalAfterSelf >= 0) {
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' enhanced (Adam brings obvious changes to Eve's physical needs, now Eve becomes more lustful and gluttonous.) ");
            } else if (p >= 1) {
            ...
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' weakened (Although Adam shows no his interest on body pressure, which does not stop Eve indulging herself sometimes.) ");
            } else if (p >= 1) {
            ...
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' weakened (Adam brought obvious changes to Eve's physical needs, now Eve starts to feel tedious about chasing fancy foods, handsome men etc.) ");
            } else if (p >= 1) {
            ...
            if (p < 0.5) {
                ...
                System.out.println("Physical needs 'remarkably' enhanced (Although Adam does obvious changes to Eve's physical needs, Eve still feel a little bit tedious about chasing fancy foods, handsome men etc.) ");
            } else if (p >= 1) {
        ...
        if (safetyAfterOpposite >= 0 && safetyAfterOpposite - safetyAfterSelf >= 0) {
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' enhanced (Adam's tenderness makes Eve reminding of her mother.) ");
            } else if (sa >= 1) {
                System.out.println("Sense of safety 'tremendously' enhanced (Adam's the sun for Eve, bringing endless warmth.)");
            }
        } else if (safetyAfterOpposite >= 0 && safetyAfterOpposite - safetyAfterSelf < 0) {
            if (sa < 0.5) {
                System.out.println("Sense of safety 'slightly' weakened (Adam is not so predictable which makes Eve worrying about sometimes.) ");
            } else if (sa >= 0.5 && sa < 1) {
                System.out.println("Sense of safety 'remarkably' weakened (Adam always makes life more insecure, even tough girl like Eve cannot stop worrying them.)");
            } else if (sa >= 1) {
            ...
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' weakened (Eve feel the hostility of surrounding in daily life, especially when Adam breaks in.) ");
            } else if (sa >= 1) {
            ...
            if (sa < 0.5) {
                ...
                System.out.println("Sense of safety 'remarkably' enhanced (Adam tries many times to tell Eve that nobody will hurt her. Eve still cannot make herself relieved.) ");
            } else if (sa >= 1) {
        ...
        if (socialAfterOpposite >= 0 && socialAfterOpposite - socialAfterSelf >= 0) {
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' enhanced (Adam does not hesitate to introduce Eve to all his friends that makes Eve happy indeed.) ");
            } else if (so >= 1) {
            ...
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' weakened (Playful Eve never can understand the aloofness of Adam, but she is influenced obviously. Now she accepts a quite weekend at home sometimes.) ");
            } else if (so >= 1) {
            ...
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' weakened (Adam constraint Eve so much, whatever, Eve now do not need social life like she used to be.) ");
            } else if (so >= 1) {
            ...
            if (so < 0.5) {
                ...
                System.out.println("Social satisfaction 'remarkably' enhanced (Eve always feel herself in a noisy flea market when being with Adam, which makes her hard to bear.) ");
            } else if (so >= 1) {
        ...
        if (respectAfterOpposite >= 0 && respectAfterOpposite - respectAfterSelf >= 0) {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' enhanced (Eve is happy with Adam's good manner.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' enhanced (Everyone likes to mention Eve as a good guy in the neighborhood, especially Adam.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' enhanced (Eve is renowned all over the city and Adam is the first fan.) ");
            }
        } else if (respectAfterOpposite >= 0 && respectAfterOpposite - respectAfterSelf < 0) {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' weakened (Eve not quite like Adam's provocative winks, which is his signature move.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' weakened (Despite of her rude friend Adam, Eve is good, says everyone in town.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' weakened (Eve have more than a dozen of times to pour her angry on Adam's disrespectful behaviors, but she holds back.) ");
            }
        } else if (respectAfterOpposite < 0 && respectAfterOpposite - respectAfterSelf <= 0) {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' weakened (Eve feels embarrassed after receiving several negative comments by Adam.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' weakened (Eve feels severe humiliated by Adam's constant mock.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' weakened (Eve now has a desperate attitude towards life due to Adam's daily humiliation.) ");
            }
        } else {
            if (re < 0.5) {
                System.out.println("Sense of esteem 'slightly' enhanced (Adam's lovely smile sometimes seems heart-touching to Eve, who is the bad girl in others' eyes.) ");
            } else if (re >= 0.5 && re < 1) {
                System.out.println("Sense of esteem 'remarkably' enhanced (Adam shows huge respect to the disrespectful Eve.) ");
            } else if (re >= 1) {
                System.out.println("Sense of esteem 'tremendously' enhanced (No one really gets to know Eve, the bad girl who is discard by the world. The only believer is Adam.) ");
            }
        }
        ...
        if (selfAchievementAfterOpposite >= 0 && selfAchievementAfterOpposite - selfAchievementAfterSelf >= 0) {
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' enhanced (Eve has a high-flying career with the help of Adam.) ");
            } else if (s1 >= 1) {
            ...
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' weakened (Eve always feels her hard work worth nothing after Adam's contempt.) ");
            } else if (s1 >= 1) {
            ...
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' weakened (Eve cannot stop the thoughts of having fun with Adam when at work.) ");
            } else if (s1 >= 1) {
            ...
            if (s1 < 0.5) {
                ...
                System.out.println("Self-fulfillment 'remarkably' enhanced (Adam helps a lot on Eves' work when Eve indulge herself too much.) ");
            } else if (s1 >= 1) {
        ...
        if (overAchievementAfterOpposite >= 0 && overAchievementAfterOpposite - overAchievementAfterSelf >= 0) {
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' enhanced (Adam tutors Eve on how to find her calling.) ");
            } else if (oa >= 1) {
                System.out.println("Intrinsic value 'tremendously' enhanced (Adam invokes Eve as her guru.) ");
            }
        } else if (overAchievementAfterOpposite >= 0 && overAchievementAfterOpposite - overAchievementAfterSelf < 0) {
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' weakened (Eve is more like to devote herself into something she really interested in while Adam has strong interested in gain social identity.) ");
            } else if (oa >= 1) {
            ...
            if (oa < 0.5) {
                ...
                System.out.println("Intrinsic value 'remarkably' enhanced (Adam leaves some unapparent marks on Eve about awaking, but all be washed away by Eve's ambition on self-fulfillment.) ");
            } else if (oa >= 1) {
        ...
        if (feelingAfterOpposite >= 0 && feelingAfterOpposite - feelingAfterSelf >= 0) {
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' enhanced (Adam likes Eve a lot. He starts to miss her when she is not around.) ");
            } else if (f >= 1) {
                System.out.println("Affection 'tremendously' enhanced (They are definitely in the vortex of love.) ");
            }
        } else if (feelingAfterOpposite >= 0 && feelingAfterOpposite - feelingAfterSelf < 0) {
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' weakened (Eve is the beloved one in the relationship.) ");
            } else if (f >= 1) {
            ...
            if (f < 0.5) {
                ...
                System.out.println("Affection 'remarkably' weakened (Everybody is not fond of our dirty little Eve, not mention of Adam.) ");
            } else if (f >= 1) {
        ...
        if (affectionAfterOpposite >= 0 && affectionAfterOpposite - affectionAfterSelf >= 0) {
            ...
            if (a < 0.5) {
                ...
                System.out.println("Bond between two people 'remarkably' weakened (Eve feels that every time she tries to get closer to Adam, Adam pull back a little bit accordingly.) ");
            } else if (a >= 1) {
            ...
            if (a < 0.5) {
                ...
                System.out.println("Bond between two people 'remarkably' enhanced (Adam tries so hard to get alone with Eve, but Eve really just do not feel a thing about Adam.) ");
            } else if (a >= 1) {
